...
public class yellowstonetorchActive extends BlockTorch {

    /** Whether the redstone torch is currently active or not. */
    private boolean torchActive = false;

    /** Map of ArrayLists of yellowstoneupdateinfo. Key of map is World. */
    ...
    private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        ...
        if (par5)
        {
            list.add(new yellowstoneupdateinfo(par2, par3, par4, par1World.getTotalWorldTime()));
        }
        ...
        {
            yellowstoneupdateinfo yellowstoneupdateinfo = (yellowstoneupdateinfo)list.get(i1);

            if (yellowstoneupdateinfo.x == par2 && yellowstoneupdateinfo.y == par3 && yellowstoneupdateinfo.z == par4)
            {
                ++l;
    ...
    protected yellowstonetorchActive(int ID, boolean On)
    {
        super(ID);
        this.torchActive = On;
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        while (list != null && !list.isEmpty() && par1World.getTotalWorldTime() - ((yellowstoneupdateinfo)list.get(0)).updateTime > 60L)
        {
            list.remove(0);
        }
        ...
        if (this.torchActive)
        {
            if (flag)
            {
				par1World.setBlock(par2, par3, par4, Colorstone.yellowstonetorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
        ...
        {
			par1World.setBlock(par2, par3, par4, Colorstone.yellowstonetorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
        }
    }
    ...
    {
		return Colorstone.yellowstonetorchActive.blockID;
    }
	...
	{
		return par1 == Colorstone.yellowstonetorchIdle.blockID;
    }

    @SideOnly(Side.CLIENT)
	public String getTextureFile () {
		return CommonProxy.YellowstoneTorchActive;
	}
}
