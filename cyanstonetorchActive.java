...
public class cyanstonetorchActive extends BlockTorch {

    /** Whether the redstone torch is currently active or not. */
    private boolean torchActive = false;

    /** Map of ArrayLists of cyanstoneupdateinfo. Key of map is World. */
    ...
    private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        ...
        if (par5)
        {
            list.add(new cyanstoneupdateinfo(par2, par3, par4, par1World.getTotalWorldTime()));
        }
        ...
        {
            cyanstoneupdateinfo cyanstoneupdateinfo = (cyanstoneupdateinfo)list.get(i1);

            if (cyanstoneupdateinfo.x == par2 && cyanstoneupdateinfo.y == par3 && cyanstoneupdateinfo.z == par4)
            {
                ++l;
    ...
    protected cyanstonetorchActive(int ID, boolean On)
    {
        super(ID);
        this.torchActive = On;
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        while (list != null && !list.isEmpty() && par1World.getTotalWorldTime() - ((cyanstoneupdateinfo)list.get(0)).updateTime > 60L)
        {
            list.remove(0);
        }
        ...
        if (this.torchActive)
        {
            if (flag)
            {
				par1World.setBlock(par2, par3, par4, Colorstone.cyanstonetorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
        ...
        {
			par1World.setBlock(par2, par3, par4, Colorstone.cyanstonetorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
        }
    }
    ...
    {
		return Colorstone.cyanstonetorchActive.blockID;
    }
	...
	{
		return par1 == Colorstone.cyanstonetorchIdle.blockID;
    }

    @SideOnly(Side.CLIENT)
	public String getTextureFile () {
		return CommonProxy.CyanstoneTorchActive;
	}
}
