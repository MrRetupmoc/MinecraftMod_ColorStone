...
public class bluestoneoreGlowing extends Block {

    private boolean glowing;

    public bluestoneoreGlowing(int ID, boolean Glow)
    {
	...
	public String getTextureFile () {
		return CommonProxy.BluestoneOre;
	}
    ...
    {
        par1World.setBlock(par2, par3, par4, Colorstone.bluestoneoreGlowing.blockID);
    ...
    {
        par1World.setBlock(par2, par3, par4, Colorstone.bluestoneore.blockID);
    }
    ...
    {
		return this.blockID == Colorstone.bluestoneore.blockID ? Colorstone.bluestone.itemID : (this.blockID == Colorstone.bluestoneoreGlowing.blockID ? Colorstone.bluestone.itemID : this.blockID);
    }
    ...
    {
		return new ItemStack(Colorstone.bluestone);
    }
}
